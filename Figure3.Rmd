---
title: "Ash manuscript Figure 3A"
...
```{r}
#Save output to file
tiff("~/Documents/Ash/Figures/3A.tiff", units="mm", width=180, height=100, res=300)
violin
dev.off()
png("~/Documents/Ash/Figures/3A.png", units="mm", width=180, height=100, res=300)
violin
dev.off()
jpeg("~/Documents/Ash/Figures/3A.jpg", units="mm", width=180, height=100, res=300)
violin
dev.off()
```
